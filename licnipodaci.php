...
?>
    ...
    <title>CRM Aplikacija - Lični podaci</title>
...
<script type="text/javascript">
    $(document).ready(function () {
      ...
      //      defaultSorting: 'imeprezime ASC', //Set default sorting
            actions: {
                listAction: 'php/getEarnings.php?kid=<?php echo $_SESSION['kid']?>',
...
//		  height: 500,
        ...
        duration: 1000,
        easing: 'out',
		colors: ['#0b67cd', '#F52A37'],
      },
        };
		
		var jsonData = $.ajax({
          url: "php/getEarningsData.php?kid=<?php echo $_SESSION['kid']?>",
          dataType:"json",
          async: false
          }).responseText;
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Primanja
                            <small>Podaci o Vašim primanjima</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-pie-chart"></i>  Grafik primanja
                            </li>
						...
						<ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-table"></i>  Tabela primanja
                            </li>
