...
<script type="text/javascript">
   ...
   //             createAction: '/GettingStarted/CreatePerson',
    ...
    //    icon: '/images/pdf.png',
        text: 'Preuzmi Excel',
        click: function () {
            window.location = 'php/getMyAccountsExcel.php?kid=<?php echo $_SESSION['kid']?>';
        }
    }]
},
            fields: {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Moji accounti
                            <small>Accounti za koje ste zaduženi</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-money"></i>  Accounti
                            </li>
                        </ol>
