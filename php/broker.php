...
class Broker {
	...
	public function updateKomercijalista($kid, $ime, $prezime, $datum_zaposlenja) {
		$sql = "UPDATE komercijalista SET ime = ('".$ime."'), prezime = ('".$prezime."'), datum_zaposlenja = ('".$datum_zaposlenja."') WHERE kid = ('".$kid."')";
		return $this->query($sql);	
	}
	...
	public function returnKomercijalisti() {
		$sql = "SELECT kid, ime, prezime, datum_zaposlenja from komercijalista";
		return ($this->query($sql));	
	}
